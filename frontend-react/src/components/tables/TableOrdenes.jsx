...
const showAlert = (id) => {
  ...
  return (
    ...
    <FormControl style={{paddingLeft: '20px'}}>
      ...
      >
        <FormControlLabel value="todos" control={<Radio />} label="Todos" onClick={() => setDataOrders(dataOrdenes)} />
        <FormControlLabel value="terminado" control={<Radio />} label="Terminado" onClick={() => filterResults('Terminado')}/>
        <FormControlLabel value="pendiente" control={<Radio />} label="Pendiente" onClick={() => filterResults('Pendiente')}/>
        <FormControlLabel value="cancelado" control={<Radio />} label="Cancelado" onClick={() => filterResults('Cancelado')}/>
      </RadioGroup>
    </FormControl>
    {/* Data table */}
      <Paper>
        <TableContainer>
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            ...
            <TableBody>
              {dataOrders.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((item) => (
